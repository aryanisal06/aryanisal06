...
- 🔐 **Offensive & Defensive Security:** CTFs, vulnerability research, penetration testing workflows, and GRC fundamentals.
- ⚙️ **Systems Programming & OS Internals:** Kernel-level interactions, memory inspection, and threat detection mechanisms.
- 🌐 **Secure Web Engineering:** Building robust web applications using TypeScript and React with strong auth and input sanitization.
- 🔍 **Digital Forensics & Incident Response (DFIR):** Traffic analysis with Wireshark, memory dumps, and log parsing.
...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=c,python,bash,linux,ts,react,docker,git,github,vscode" />
  </a>
</p>

```markdown
• Languages:       C, Python, Bash, TypeScript, SQL
• Security Tools:  Wireshark, Burp Suite, Nmap, Metasploit, GDB, Ghidra
• Frameworks/DBs:  React, Node.js, Next.js, PostgreSQL
• Environments:    Linux (Debian/Arch/Kali), Docker, Virtualization
```
